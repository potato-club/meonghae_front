...
class CushionSVG extends StatelessWidget {
  final Color color1;
  final Color color2;
  const CushionSVG({super.key, required this.color1, required this.color2});
