...
import 'package:meonghae_front/widgets/post_edit_screen/category_form_widget.dart';
import 'package:meonghae_front/widgets/post_edit_screen/images_form_widget.dart';
...
class _WriteFormWidgetState extends State<WriteFormWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GetX<PostEditController>(builder: (controller) {
        controller.titleTextController.text = controller.editPost.value.title;
        controller.contentTextController.text =
            controller.editPost.value.content;
        return Column(
