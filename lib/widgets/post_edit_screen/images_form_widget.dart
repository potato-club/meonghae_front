...
class _ImagesFormWidgetState extends State<ImagesFormWidget> {
  ...
  Widget build(BuildContext context) {
    return GetX<PostEditController>(builder: (controller) {
      var maxImageLength = Get.find<PostController>().type.value == 3 ? 5 : 3;
      return SingleChildScrollView(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              if (controller.editImages.length < maxImageLength)
                Padding(
              ...
              for (int i = 0; i < controller.editImages.length; i++)
                Row(
                  children: [
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(10)),
                          child: Image.file(controller.editImages[i],
                              fit: BoxFit.cover),
                        ),
                      ),
                    )
